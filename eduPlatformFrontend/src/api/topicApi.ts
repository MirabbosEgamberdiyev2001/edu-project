...
export const topicApi = {
  getTopicTree: (subjectId: string, gradeLevel: number | null, signal?: AbortSignal) =>
    api.get<ApiResponse<TopicTreeDto[]>>(`/subjects/${subjectId}/topics`, {
      params: gradeLevel != null ? { gradeLevel } : {},
      signal,
    }),
